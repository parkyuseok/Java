...
public class MainClass01 {
	public static void main(String[] args) {
		...
		/*
		 * int type 변수에 byte type 변수에 있는 값을 대입하는 것은 범위가 상대적으로 좁은 데이터를 넓은 범위의 변수에 대입하는
		 * 것이기 때문에 오류가 발생하지 않는다.
		 */
		int tmp = iByte;

		// casting 연산자를 이용해서 type 을 byte type으로 인식 시킨다(바꾼다)
		byte tmp2 = (byte) iInt;
		...
		double tmp3=num1;
		// double type을 float type으로 casting 해서 대입하기
